 ...
 * @author Jose Luis
 */
class Pasaje_Machala extends Boleto {

    // Constructor  con 0 argumentos
    public Pasaje_Machala() {
    }// Fin del constructor

    // Constructor  con 5 argumentos
    public Pasaje_Machala(String numCedula, String nombre, String apellido, String Tipo_Pasajero) {
    ...
    public String toString() {
        return String.format("%s: %s\n%s: $%,.2f; %s: %.2f",
                "Destino Machala", super.toString(),
